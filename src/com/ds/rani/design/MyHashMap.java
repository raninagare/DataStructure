...
/*Approach: Internally hashmap is implemented as array of linkedlist,
 take a key, apply hash function and find bucket no. If more than one key maps with the same bucket number
 then to resolve the collision I have created array of LinkedList */
